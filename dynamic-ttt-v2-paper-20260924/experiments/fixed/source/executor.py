...
CHECKPOINT_HASH = '9aa0e1d7ceb12785ebe326fc9d2f162f23f1c544e376b38d10790945ebb65990'
TOL = 1e-12
...
class Evaluator:
    ...
    def evaluate(self,sequence,capture=False,force=False):
        ...
        for layer in LAYERS:
            m=self.model.model.layers[layer].mlp;m._dynamic_sequence=list(seq);m._branch_id=branch;m._capture_identity=capture;m._events=[];m._generation_forward_calls=0;m._captured_final_state=None
