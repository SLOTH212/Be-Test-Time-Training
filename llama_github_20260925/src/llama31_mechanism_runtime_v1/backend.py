...
class Backend:
 def __init__(self,cfg,rank):
  sys.path[:0]=[cfg['llama_port'],cfg['llama_port']+'/source']
  import torch
  ...
  self.c=m.rt.source_functions('provenance/original/kp/dependencies/closure_core.py',['th','base','PrefixKVInjectCache','install_formal','configure','restore','donor_prefix'],env,chunk=4096)
  self.f=m.rt.source_functions('provenance/original/kp/dependencies/factorial_core.py',['run_prompt'],{'torch':torch,'c':self.c,'LAYERS':m.LAYERS,'base':self.c.base,'th':self.c.th},chunk=4096)
