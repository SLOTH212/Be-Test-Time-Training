...
class Context:
    def __init__(self, run):
        ...
        self.pipe=Path('/home/USER/ttt_phase_c_migrated_v1/ttt_phase_c_migration_20260813/data/dev_authority')
        self.ckpt=Path('/home/USER/ttt_phase_c_migrated_v1/ttt_phase_c_migration_20260813/checkpoint')
        self.scorer_path=Path('/home/USER/ttt_phase_c_migrated_v1/ttt_phase_c_migration_20260813/local_code_dependencies/opencompass_scorer/common.py')
