...
V1 = Path(r"C:\datasets\prolong_1b_32k_qwen3_v1")
V2 = Path(r"C:\datasets\prolong_1b_32k_qwen3_v2")
ROOT = Path(r"C:\datasets\prolong_1b_32k_qwen3_v3_streaming")
sys.path.insert(0, str(V1 / "runtime_pkgs"))
...
QWEN = Path(r"C:\models\Qwen3-4B-Base")
