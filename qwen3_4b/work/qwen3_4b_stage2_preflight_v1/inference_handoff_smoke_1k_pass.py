...
R=Path('/path/to/ttt');H=R/'work/qwen3_4b_stage2_preflight_v1/debug_stage2_hf_v2';A=R/'audits/qwen3_4b_stage2_30m_32k_gpu23_preflight_v1'
...
assert cfg.ttt_layers==[0,6,12,18,24,30] and cfg.ttt_chunk==1024
...
for mode in ['OFF','L0']:
 ...
 ids=raw if mode=='OFF' else raw.repeat(1,(1025+raw.shape[1]-1)//raw.shape[1])[:,:1025]
...
receipt={'status':'PASS','DEBUG_ONLY':True,'PAPER_RESULT':False,'checkpoint':str(H),'loading_info':info,'results':results,'runtime':'ttt_inference_runtime_v1','runtime_package_sha256':'65a0d7bd9c8801c92fc30477ab8662d3eb52261612eff2acef0bbeb3edf6ba51','benchmark_run':False,'training_chunk':4096,'inference_chunk':1024,'inference_lr':cfg.ttt_lr,'inference_delta_clip':cfg.ttt_update_clip_norm}
