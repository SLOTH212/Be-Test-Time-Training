...
audit=root/"audits/qwen3_4b_stage1_gpu23_prelaunch_v1"
work=root/"work/qwen3_4b_stage1_gpu23_prelaunch_v1"
runs=root/"runs/qwen3_4b_gpu23_prelaunch_v1"
...
try:
 assert (runs/"smoke_A/complete.json").exists(),"INITIAL_SMOKE_NOT_COMPLETE"
