...
REPORT = Path('/path/to/ttt/audits/qwen3_4b_stage1_gpu23_prelaunch_v1/NCCL_GPU_MAPPING.json')
...
def main():
    ...
    expected_uuid = ["GPU-fb7ba9a8-ce12-65a4-a9cf-5b5b7506b0ed", "GPU-351e23d4-250b-6a70-2c66-d2fb0221a25a"][local_rank]
    if str(props.uuid).removeprefix("GPU-") != expected_uuid.removeprefix("GPU-"):
        raise RuntimeError(f"CUDA_PHYSICAL_MAPPING_MISMATCH {props.uuid}")
    local = {
        "rank": rank,
