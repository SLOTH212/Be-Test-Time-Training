...
A_ROOT = Path('/path/to/ttt/runs/qwen3_4b_gpu23_prelaunch_determinism_v4/fresh_A/checkpoints')
B_ROOT = Path('/path/to/ttt/runs/qwen3_4b_gpu23_prelaunch_determinism_v4/fresh_B/checkpoints')
AUDIT = Path('/path/to/ttt/audits/qwen3_4b_stage1_gpu23_prelaunch_determinism_v4/DETERMINISTIC_FRESH_NUMERIC_PARITY.json')
