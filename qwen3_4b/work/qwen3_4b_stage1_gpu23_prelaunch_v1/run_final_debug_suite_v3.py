...
runs=root/"runs/qwen3_4b_gpu23_prelaunch_final_v3"
worker=root/"src/training_runtime/code/workers/distributed_train_worker.py"
config=work/"real_final_debug_v3.yaml"
env=os.environ.copy()
...
try:
 ...
 train("REAL_SMOKE_A5","uninterrupted_A5",10)
 aroot=runs/"uninterrupted_A5/checkpoints";slot=aroot/"slot_B";manifest=json.loads((slot/"manifest.json").read_text())
 ...
 train("EDGE_ONE_TOKEN","edge_one_token",2,["--debug-start-record","15220"],cfg=work/"real_edge_final_v3.yaml")
 train("EDGE_ODD_FINAL","edge_odd_final",1,["--debug-start-record","38334"],cfg=work/"real_edge_final_v3.yaml")
