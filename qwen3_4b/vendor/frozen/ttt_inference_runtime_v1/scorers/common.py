...
SEED = 42
BENCHMARK_ROOT = Path("/root/autodl-tmp/benchmarks") / VERSION
MODEL_SPECS = {
    "base": "/root/autodl-tmp/models/Qwen3-1.7B-Base",
    "ckpt1000": "/root/autodl-tmp/outputs/qwen3_1_7b_16k_100m_no_ttt_1000step/checkpoints/global_step_1000/hf_ckpt",
    "ckpt500": "/root/autodl-tmp/outputs/qwen3_1_7b_16k_100m_no_ttt_1000step/checkpoints/global_step_500/hf_ckpt",
}
...
TASKS = [
    ...
    dict(name="ruler_qa_squad_16k", family="qa", max_new_tokens=50, evaluator="RulerQaEvaluator", kwargs=dict(dataset="squad", path="/root/opencompass_clean/.cache/opencompass/data/ruler/dev-v2.0.json")),
    dict(name="ruler_qa_hotpotqa_16k", family="qa", max_new_tokens=50, evaluator="RulerQaEvaluator", kwargs=dict(dataset="hotpotqa", path="/root/opencompass_clean/.cache/opencompass/data/ruler/hotpotqa.json")),
