#!/usr/bin/env python3
import hashlib,math,sys,types
from pathlib import Path
import torch
import torch.nn.functional as F

ROOT=Path('/home/USER/ttt_mechanism_analysis_v1/trajectory_state_closure_audit_v1')
UP=Path('/home/USER/ttt_mechanism_analysis_v1/early_state_later_regime_transplant_v1')
RUNTIME=Path('/home/USER/ttt_dynamic_mining_v1/phase_d_enriched_dynamic_mining_v1/runtime/code')
sys.path.insert(0,str(RUNTIME))
import dynamic_runner as dr
...
def load():
 ctx=dr.Context(RUNTIME);model,tok=dr.load_model(ctx);install_formal(model);model.requires_grad_(False);return ctx,model,tok
