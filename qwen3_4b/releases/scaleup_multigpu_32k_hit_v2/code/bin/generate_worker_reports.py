...
PROJECT=Path('/root/autodl-tmp/ttt/inplace_ttt_gated_ntp_perf_parity_v1')
...
command='tmux new-session -d -s gated_ntp_300m_qa10m_eval13k "bash /root/autodl-tmp/ttt/pipelines/gated_ntp_300m_qa10m_eval13k_v2/bin/run_pipeline.sh 2>&1 | tee -a /root/autodl-tmp/ttt/pipelines/gated_ntp_300m_qa10m_eval13k_v2/logs/pipeline_console.log"'
