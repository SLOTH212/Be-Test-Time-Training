...
BENCH=Path('/root/autodl-tmp/benchmarks/ruler_16k_13task_1000sample_v1')
sys.path[:0]=[str(ROOT),str(PROJECT),'/root/opencompass_clean/tools/autodl/ruler_benchmark_v1']
