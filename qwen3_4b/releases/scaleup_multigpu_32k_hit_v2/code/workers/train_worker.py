...
sys.path[:0] = [str(ROOT), str(PROJECT), '/root/opencompass_clean/tools/autodl/v2_full_epoch_ruler_bs2']
...
def main():
    ...
    dataset_manifest=(Path('/root/autodl-tmp/ttt/data/continual_16k_300m_prolong_v3_full/dataset_manifest.json') if args.stage==1 else Path('/root/autodl-tmp/data/qa_replay_10m_v1_answer_context_masks_v1/derivation_manifest.json'))
