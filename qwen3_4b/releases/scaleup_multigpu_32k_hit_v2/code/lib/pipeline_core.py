...
PIPELINE_ROOT = Path('/root/autodl-tmp/ttt/pipelines/gated_ntp_300m_qa10m_eval13k_v2')
PROJECT_ROOT = Path('/root/autodl-tmp/ttt/inplace_ttt_gated_ntp_perf_parity_v1')
EXPECTED_HEAD = '190580a29780030969cd337763098188bce8c88c'
BENCHMARK_ROOT = Path('/root/autodl-tmp/benchmarks/ruler_16k_13task_1000sample_v1')
BENCHMARK_SHA = 'f921d4bbf2641b1069c925e534beee07e1a3749c4c5f221328ffe4656ab3b977'
LONGTEXT_ROOT = Path('/root/autodl-tmp/ttt/data/continual_16k_300m_prolong_v3_full')
QA_ROOT = Path('/root/autodl-tmp/data/qa_replay_10m_v1')
QA_MASK_ROOT = Path('/root/autodl-tmp/data/qa_replay_10m_v1_answer_context_masks_v1')
