...
def main():
    ...
    if int(os.environ.get("WORLD_SIZE", "0")) != 4 or int(os.environ.get("LOCAL_RANK", "-1")) not in (0, 1, 2, 3):
    ...
    lineage_path = Path(__file__).with_name("stage2_loss_lineage.json")
    ...
    try:
        ...
        allowlist = str(cfg["physical_gpu_allowlist"])
