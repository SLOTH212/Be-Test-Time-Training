...
def main():
    ...
    try:
        ...
        dataset_root = Path(cfg["train_data"]).parent
        for key, relative in (("dataset_authority_sha256", "authority/DATASET_AUTHORITY_V3.json"),
                              ("data_manifest_sha256", "manifests/FINAL_DATA_FILE_HASHES.jsonl")):
        ...
        while True:
            ...
            local_runtime = {
                ...
                "physical_gpu": os.environ["CUDA_VISIBLE_DEVICES"].split(",")[context.local_rank],
